...
export const getPdf = (data = [], cabecera = {}) => {
  ...
  dataFinal.forEach(i => {
    ...
    const artistica = [
      ...
      { text: (i.eca.trimestre3).toFixed(cabecera.decimal), alignment: "center" },
      { text: (i.eca.proyecto).toFixed(cabecera.decimal), alignment: "center", },
      { text: (i.eca.promedio_simple).toFixed(cabecera.decimal), alignment: "center", },
      { text: "10%", alignment: "center", },
      { text: (i.eca.promedio_pond).toFixed(cabecera.decimal), alignment: "center", },
    ...
    const efisica = [
      ...
      { text: (i.efisica.proyecto).toFixed(cabecera.decimal), alignment: "center", },
      { text: (i.efisica.promedio_simple).toFixed(cabecera.decimal), alignment: "center", },
      { text: "10%", alignment: "center", },
      { text: (i.efisica.promedio_pond).toFixed(cabecera.decimal), alignment: "center", },
    ...
    const ingles = [
      ...
      { text: (i.ingles.proyecto).toFixed(cabecera.decimal), alignment: "center", },
      { text: (i.ingles.promedio_simple).toFixed(cabecera.decimal), alignment: "center", },
      { text: "10%", alignment: "center", },
      { text: (i.ingles.promedio_pond).toFixed(cabecera.decimal), alignment: "center", },
